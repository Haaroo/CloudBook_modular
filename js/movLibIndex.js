...
const librosProgramacionContainer = document.querySelector('#libros-programacion .libros-container-programacion');
        ...
        function abrirPaginaDetalle(titulo, autor, descripcion) {
            const url = `detalle_libro.html?titulo=${encodeURIComponent(titulo)}&autor=${encodeURIComponent(autor)}&descripcion=${encodeURIComponent(descripcion)}`;
            ...
            libros.forEach((libro, index) => {
                ...
                imagen.addEventListener('click', function() {
                    abrirPaginaDetalle(
                        ...
                        libro.volumeInfo.authors ? libro.volumeInfo.authors.join(', ') : 'Autor desconocido',
                        libro.volumeInfo.description ? libro.volumeInfo.description : 'No hay descripción disponible'
                    );
                });
